...
namespace Tako.Modbus.Client.UnitTest
{
    ...
    public class AsciiModbusDataConvertTest
    {
        ...
        {
            AsciiModbusDataConvert target = new AsciiModbusDataConvert();
            byte[] ResultArray = this._modbusUtility.HexStringToBytes("30 30 34 45 32 36 41 34 46 46 39 45 30 30 37 37 32 45 30 35 30 38 42 42 30 34 36 45 30 30 30 31 30 34 45 44 46 34 35 42");
        ...
        {
            AsciiModbusDataConvert target = new AsciiModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("45 36 44 46 33 37 ");
        ...
        {
            AsciiModbusDataConvert target = new AsciiModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("33 37 41 36 45 39 42 41 46 43 44 36 34 30 30 30 38 44 45 41 42 41 36 45 33 46 33 35 43 30 32 30 30 30 30 30 30 30 30 30 30 30 30 30");
        ...
        {
            AsciiModbusDataConvert target = new AsciiModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("44 36 38 30 33 44 46 43 30 36 31 30 42 46 39 45 38 37 39 34 34 31 34 35 45 39 37 39 43 32 46 36 35 31 45 43 43 34 39 41 30 30 30 30");
