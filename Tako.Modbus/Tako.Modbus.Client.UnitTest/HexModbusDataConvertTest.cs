...
namespace Tako.Modbus.Client.UnitTest
{
    ...
    public class HexModbusDataConvertTest
    {
        ...
        {
            HexModbusDataConvert target = new HexModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("00 4E 26 A4 FF 9E 00 77 2E 05 08 BB 04 6E 00 01 04 ED F4 5B");
        ...
        {
            HexModbusDataConvert target = new HexModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("E6 DF 37");
        ...
        {
            HexModbusDataConvert target = new HexModbusDataConvert();
            byte[] ResultArray = _modbusUtility.HexStringToBytes("C2 8F 3D F5 E6 B4 40 07 38 52 C2 B6 BD 7B C0 21 00 00 00 00 00 00");
        ...
        public void ToDoubleTest()
        {
            ...
            //byte[] ResultArray = _modbusUtility.HexStringToBytes("37 A6 E9 BA FC D6 40 00 8D EA BA 6E 3F 35 C0 20 00 00 00 00 00 00");
            //IEnumerable<double> expected = new double[] { 2.12345678901234d, -8.12345678901234d };

            //D7 0A 70 A3 0A 3D 40 18
            byte[] ResultArray = _modbusUtility.HexStringToBytes("D7 0A 70 A3 0A 3D 40 18");
