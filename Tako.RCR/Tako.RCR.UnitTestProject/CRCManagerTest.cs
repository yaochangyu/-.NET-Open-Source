...
namespace Tako.RCR.UnitTestProject
{
    /// <summary>
    ...
    public class CRCManagerTest
    {
        ...
        public void CRC16_ASCII_Test()
        {
            ...
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16);
            ...
            Assert.AreEqual(expectedCheckSumValue, actual.CheckSumValue);
            Assert.AreEqual(expectedFullData, actual.FullData);
            Assert.IsTrue(expectedCheckSumArray.SequenceEqual(actual.CheckSumArray));
        }
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC32);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16CCITT_0x0000);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16CCITT_0x1D0F);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16CCITT_0xFFFF);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16Kermit);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC8);
            var source = "1234567890";
        ...
        {
            this._manager.DataFormat = EnumOriginalDataFormat.ASCII;
            AbsCRCProvider provider = this._manager.CreateCRCProvider(EnumCRCProvider.CRC16Modbus);
            var source = "1234567890";
